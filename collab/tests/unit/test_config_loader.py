...
from collab.runtime.config_loader import (
    _expand_presets,
    load_config_bundle,
...
class ConfigLoaderUnitTest(unittest.TestCase):
    def test_loads_standalone_config_inventory_and_fact_refs(self) -> None:
        ...
        self.assertEqual(len(bundle.strategies), 17)
        ...
        self.assertEqual(
            bundle.provider_refs["codex"]
            .relative_to(bundle.support_collab_root)
            .as_posix(),
    ...
    def test_resolves_impl_request_from_collab_configs(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            request = {
                ...
                "targets": {
                    "paths": ["collab/runtime/task_entrypoint.py"],
                    "globs": [],
                },
    ...
    def test_step_override_takes_precedence_over_user_provider_defaults(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            request = {
                ...
                "targets": {
                    "paths": [
                        "collab/runtime/config_loader.py",
                        "collab/runtime/phase_runner.py",
                        "collab/runtime/runtime_coordinator.py",
                        "collab/runtime/providers/copilot.py",
                    ],
                    "globs": [],
                },
                "constraints": {"hard": [], "soft": []},
    ...
    def test_profile_effort_survives_user_provider_defaults_in_live_env(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            request = {
                ...
                "targets": {
                    "paths": ["collab/runtime/config_loader.py"],
                    "globs": [],
                },
                "constraints": {"hard": [], "soft": []},
                "output": {
