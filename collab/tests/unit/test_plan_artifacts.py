...
```json
{
  ...
  "implementationSteps": [
    {"id": "S01", "description": "Update phase runner", "targetFiles": ["collab/runtime/phase_runner.py"]},
    "Add tests"
  ],
  "targetPaths": ["collab/runtime/phase_runner.py", "collab/tests/"],
...
"""}}
        ...
        self.assertEqual(plan["targetPaths"][0], "collab/runtime/phase_runner.py")
    ...
    def test_synthesizes_steps_from_markdown_numbered_list(self) -> None:
        normalized = {"payload": {"content": """
# Canonical Plan
1. Update collab/runtime/phase_runner.py
2) Add collab/tests/unit/test_plan_artifacts.py
- [ ] verify manifests
"""}}
        ...
        self.assertEqual(
            ...
            "Update collab/runtime/phase_runner.py",
        )
...
```json
{
  ...
  "targetPaths": ["collab/runtime/phase_runner.py"],
