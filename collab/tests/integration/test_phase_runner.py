...
from collab.runtime.runtime_coordinator import CoordinationResult
...
class PhaseRunnerIntegrationTest(unittest.TestCase):
    def _mock_coordination_result(
        ...
        *,
        ...
        task_root = root / "collab" / "artifacts" / "tasks" / task_id
        state_root = root / "collab" / "state" / "tasks" / task_id
  ...
  "implementationSteps": [
    {
      ...
      "targetFiles": ["collab/runtime/plan_artifacts.py"]
    }
  ],
  "targetPaths": ["collab/runtime/plan_artifacts.py"],
  "checklist": [
    {
      "id": "C001",
      ...
      "category": "impl",
      "status": "pending",
      "targetFiles": ["collab/runtime/phase_runner.py"]
    }
  ]
}
```
