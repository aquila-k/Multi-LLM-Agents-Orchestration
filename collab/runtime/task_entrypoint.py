...
from collab.runtime.manifest_store import build_manifest_snapshot, build_pause_confirm
from collab.runtime.context_bridge import load_task_context
...
from collab.runtime.shell_digest import derive_shell_digest, persist_shell_digest
...
def _update_task_registry(
    *, root_dir: Path, request: dict[str, Any], status: str, updated_at: str
    ...
    registry_path = root_dir / "collab" / "state" / "task-registry.json"
