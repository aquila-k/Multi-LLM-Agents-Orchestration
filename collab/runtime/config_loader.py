...
from collab.runtime.capabilities import CapabilityRecord, CapabilityRegistry
from collab.runtime.pathing import resolve_support_collab_root
from collab.runtime.routing import RoutingEngine
...
def load_config_bundle(root_dir: Path) -> RuntimeConfigBundle:
    support_collab_root = _resolve_support_collab_root(root_dir)
    config_root = support_collab_root / "configs"
    internal_root = config_root / "internal"
    facts_root = support_collab_root / "facts"
    ...
    user_config = _load_user_config(support_collab_root)
...
def resolve_runtime_config(
    *,
    ...
    resolved_config = {
        ...
        "supportCollabRoot": str(bundle.support_collab_root),
        "phase": phase,
...
def _resolve_support_collab_root(root_dir: Path) -> Path:
    return resolve_support_collab_root(root_dir.resolve())
