...
from collab.runtime.loop_state import build_loop_state_artifact
from collab.runtime.manifest_store import build_runtime_pause_confirm
...
from collab.runtime.stop_categories import (
...
def _extract_task_snapshot(
    ...
    return {
        ...
        "open_questions": _extract_questions(
...
def _write_back_context(
    *,
    ...
    from collab.runtime.context_bridge import (
        log_decision,
        log_episode,
        save_task_snapshot,
    )
        ...
        while phase_index < len(phase_sequence):
            ...
            if not phase_had_blocked_step:
                _write_back_context(
                    ...
                    expected_revision=(
                        phase_request.get("operator_context", {})
                        .get("stored_context_revision", 0)
                    ),
                )
