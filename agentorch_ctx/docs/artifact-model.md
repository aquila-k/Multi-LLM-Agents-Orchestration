...
Define the artifact families that the standalone agentorch runtime persists and
...
`agentorch_ctx/` owns artifact persistence, naming, and linkage. Controllers read
