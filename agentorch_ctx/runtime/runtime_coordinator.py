...
from agentorch_ctx.runtime.diff_capture import (
    capture_git_diff,
    check_paths_in_allowlist,
)
from agentorch_ctx.runtime.manifest_store import extend_manifest_snapshot
from agentorch_ctx.runtime.mutation_authority import (
...
from agentorch_ctx.runtime.review_gate import evaluate_review_gate
from agentorch_ctx.runtime.shell_digest import (
    derive_shell_digest,
    ingest_shell_digest,
    persist_shell_digest,
)
from agentorch_ctx.runtime.stop_categories import UNSAFE_APPLY
...
class RuntimeCoordinator:
    ...
    def execute_phase(
        ...
        *,
        ...
        state_dir = task_state_dir(self.root_dir, task_id)
