...
from agentorch_ctx.runtime.pathing import state_root, task_artifacts_dir
    ...
    def test_markdown_source_is_canonicalized_and_state_is_initialized(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            result = skill.dispatch(
                ...
                targets={"paths": ["agentorch_ctx/runtime"], "summary": "runtime only"},
            ...
            self.assertEqual(request["targets"]["paths"], ["agentorch_ctx/runtime"])
            ...
            task_artifact_root = task_artifacts_dir(root, result.task_id)
            ...
            registry_path = state_root(root) / "task-registry.json"
