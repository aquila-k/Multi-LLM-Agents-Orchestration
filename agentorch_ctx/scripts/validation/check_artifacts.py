...
def check_shell_digest_derivation(_workspace: Path) -> dict:
    ...
    sys.path.insert(0, str(REPO_ROOT))
    from agentorch_ctx.runtime.shell_digest import derive_shell_digest
...
def check_markdown_renderer(_workspace: Path) -> dict:
    ...
    try:
        ...
        try:
            from agentorch_ctx.runtime import renderers
        ...
        return {
            ...
            "notes": "render_markdown_document not found in agentorch_ctx.runtime.renderers.markdown.",
        }
    except Exception as exc:
        return {
            "check": "markdown_renderer",
